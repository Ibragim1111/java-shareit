...
public class ItemController {
    ...
    public ItemDto createItem(@Valid @RequestBody ItemDto itemDto,
                              @Valid @RequestHeader(value = "X-Sharer-User-Id", required = false) Long ownerId) {
        if (ownerId == null) {
            throw new RuntimeException("X-Sharer-User-Id header is required");
        }
    ...
    @GetMapping("/search")
    public List<ItemDto> searchItems(@Valid @RequestParam String text) {
